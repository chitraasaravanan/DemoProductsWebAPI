...
namespace DemoProductsWebAPI.Tests.UnitTestcase
{
    public class ProductsControllerUnitTests
    {
        ...
        public async System.Threading.Tasks.Task Get_Calls_Service_GetAll()
        {
            ...
            mediatorMock.Setup(m => m.Send(It.IsAny<Application.Products.Queries.GetAllProductsQuery>(), It.IsAny<System.Threading.CancellationToken>())).ReturnsAsync(new List<ProductDto>());
        ...
        {
            var mediatorMock = new Mock<MediatR.IMediator>();
            mediatorMock.Setup(m => m.Send(It.IsAny<Application.Products.Queries.GetProductByIdQuery>(), It.IsAny<System.Threading.CancellationToken>())).ReturnsAsync((ProductDto?)new ProductDto { Id = 1 });
            var controller = new ProductsController(mediatorMock.Object);
        ...
        {
            var mediatorMock = new Mock<MediatR.IMediator>();
            mediatorMock.Setup(m => m.Send(It.IsAny<Application.Products.Commands.CreateProductCommand>(), It.IsAny<System.Threading.CancellationToken>())).ReturnsAsync(new ProductDto { Id = 5 });
            var controller = new ProductsController(mediatorMock.Object);
        ...
        {
            var mediatorMock = new Mock<MediatR.IMediator>();
            mediatorMock.Setup(m => m.Send(It.IsAny<Application.Products.Commands.UpdateProductCommand>(), It.IsAny<System.Threading.CancellationToken>())).ReturnsAsync(true);
            var controller = new ProductsController(mediatorMock.Object);
        ...
        {
            var mediatorMock = new Mock<MediatR.IMediator>();
            mediatorMock.Setup(m => m.Send(It.IsAny<Application.Products.Commands.DeleteProductCommand>(), It.IsAny<System.Threading.CancellationToken>())).ReturnsAsync(true);
            var controller = new ProductsController(mediatorMock.Object);
